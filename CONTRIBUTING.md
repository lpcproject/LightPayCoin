Contributing to LightPayCoin Core
============================

The LightPayCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LightPayCoin Core project, and is not to be
confused with overall LightPayCoin Network Protocol consensus changes.

Whether a pull request is merged into LightPayCoin Core rests with the project merge
...
Patches that change LightPayCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the LightPayCoin consensus, it must have been
...
The project leader is the release manager for each LightPayCoin Core release.
